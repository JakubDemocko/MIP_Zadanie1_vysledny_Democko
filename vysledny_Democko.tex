...
this moment. We use x-means clustering [6].
...
location from user A.}\label{tab:2}

\begin{tabular}{|c|c|c|c|c|c|}
\hline
action & user & \begin{tabular}[x]{@{}c@{}}hour\\ in day\end{tabular} & \begin{tabular}[x]{@{}c@{}}day in\\ week\end{tabular} & section & location\\
\hline
1 & A & 22 & 2 & sport & work\\
2 & A & 21 & 3 & sport & work\\
...
made by different users reveals their behavioural sim-
ilarity.

\begin{equation}
similarity(u; v) =
\frac{\sum\limits_{i=0}^{n}(|U \cap C_i|+|V \cap C_i|)}{|U|+|V|}
\end{equation}
...
\bibliographystyle{plain} %alebo abbrv
